...
**Nom i cognoms:** Edim Batalla Torralba

**Data:** 23/03/26 **Grup:** 2n DAM
...
- [ ] C) Els errors 4xx indiquen un problema a la petició del client (clau incorrecta, recurs inexistent, no autoritzat); els errors 5xx indiquen un problema intern del servidor (codi defectuós, base de dades caiguda)
- [x] D) No hi ha diferència funcional; la distinció és purament semàntica i els clients HTTP els tracten de la mateixa manera
